...
const RoadMap = () => {
  return (
    <div className=" py-[25px] flex flex-col justify-center items-center px-[50px] gap-[25px] ">
      <h1 className="font-alf text-[27px] uppercase ">RoadMap</h1>
      ...
      <div className="border-2 w-full grid-cols-3 grid ">
        <h2 className=" bg-orange-500 border-2 col-span-1 p-[10px] w-full text-left text-[17px] break-all ">
          lorem impusaasf
        </h2>
        <span className="bg-orange-500 border-2 col-span-2 flex gap-[25px] p-[10px] w-full text-left text-[17px] ">
