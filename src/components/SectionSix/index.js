  ...
  return (
    <div className=" w-full flex flex-col z-10 mt-[100px] overflow-hidden ">
      <div className=" w-full z-10 ">
        <h1
          id="story"
          className="text-[60px] mt-[15px] md:text-[60px] text-[#FCDA6C] md:text-[#873016] drop-shadow font-alf uppercase text-center "
        >
          Road Map
        </h1>
      </div>
      <div className="px-[25px] ">
        <div className="w-full z-10 hover:z-50 flex flex-row justify-start mt-[75px] mb-[25px] px-[10px] md:px-[50px]">
          ...
          >
            ...
            <p className=" mt-[15px] font-alf text-center text-[20px] mx-[50px] tracking-wide text-white leading-loose ">
        ...
        <div className="w-full z-10 hover:z-50 flex flex-row justify-start px-[10px] mb-[25px] md:px-[50px]">
          ...
          >
            ...
            <p className=" mt-[15px] font-alf text-center text-[20px] tracking-wide text-white leading-loose ">
